...
async function openModal(movie_id) {
  ...
  modalEl.innerHTML = `<div class="modal__card">
        <img src="${imgDb}${respData.backdrop_path}" alt="${imgDb}${
    respData.poster_path
        ...
        <ul class="modal__movie-info">
          ...
          <li class="modal__movie-vote"> Vote / Votes ${
            respData.vote_average
          }/${respData.vote_count}</li>
          <li class="modal__movie-populerity">Popularity ${
            respData.popularity
          }</li>
          <li class="modal__movie-original-title">Original Title ${
